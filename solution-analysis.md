...
## 2. Democratic Federalism (Policy and Statutory Leverage)

* **Targeted Policy / Ordinance Revision:** Full implementation of House File 385, establishing that no patient under an involuntary court order may be discharged without a verified referral to their regional ASO for intensive case management.
* **Jurisdictional Enforcement Mechanism:** The Iowa Department of Health and Human Services (HHS) holds direct oversight of the consolidated state ASOs, possessing the authority to tie regional funding renewals to strict compliance metrics.
* **Peer State Precedent:** Matching structural frameworks exist in Michigan (Kevin Law, incorporating judicial contempt mechanisms for non-compliant hospitals) and Louisiana, which enacted strict discharge notification laws to eliminate psychiatric streeting as detailed in the legislative record.

## 3. Dual Power and Economic Solidarity (Autonomous Infrastructure)
